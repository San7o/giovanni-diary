...
- [[file:c/generate-debuginfo.org][C/generate-debuginfo]]: Separate debuginfo and executable in two different files.
- [[file:python/k-means.py.org][python/k-means.py]]: Implementation of k-means clustering in Python.
- [[file:python/scikit-sample.py.org][python/scikit-sample.py]]: Example of using a ML model with scikit-learn.
